...
def load_history_from_supabase(user_key: str) -> pd.DataFrame:
    ...
    try:
        ...
        # Rename columns back to your original style if needed
        return df
    except Exception as e:
